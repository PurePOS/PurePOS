...
const string strMessageMagic = "PurePOS Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PurePOS", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Mon, 20 Aug 2015 18:49:00 CET";
        CTransaction txNew;
        txNew.nTime = 1440089408;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1440089408;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1189714;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb5fd1bdb4943092a557e5ae6216fd9dcfe7cc9bd864c163e7c9cf37513291c2d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xaa, 0xa2, 0xb2, 0xc4 };
